...
function updatepeopleinspace(){$.get(peopleinspaceurl,function(data,textStatus,jqXHR){peoplearray=data.people;htmlend="";document.getElementsByClassName("peopleinspace")[0].style.height=((9*peoplearray.length)+5)+"vw";for(person of peoplearray){now=new Date();launch=new Date(person.launchdate);diffdays=" ("+Math.floor((now-launch)/(1000*3600*24)).toString()+" Days)";htmlend+="<div class=\"person animonload1\">";htmlend+="<img src=\""+personicon+"\" class=\"personicon animonload1\" alt=\""+person.bio+"\" title=\""+person.bio+"\"></img>"
htmlend+="<div class=\"personname animonload1\">"+person.name+diffdays+"</div>";htmlend+="<div class=\"craft animonload1\">"+person.location;htmlend+="<img src=\""+shipicon+"\" class=\"crafticon animonload1\"></img>";htmlend+="</div></div><br>";}
