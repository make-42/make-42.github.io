...
if(String.fromCharCode(event.keyCode).toLowerCase()==testtarget[testposition]){typingwords.children[testposition].className="typing-letter-confirmed";testposition++;}else if(event.keyCode==8){if(testposition!=0){typingwords.children[testposition-1].className="typing-letter-unconfirmed";testposition--;}}
