...
typingletterindicator.style.transform="scaleX("+(1+(testposition-lastposition)/4)+")";if(testposition==testlength){typingletterindicator.style.top=typingwords.children[0].offsetTop+"px"
typingletterindicator.style.left=typingwords.children[0].offsetLeft+"px"}
lastposition=testposition}
function setuptypingtest(){testtarget="";testposition=0;testerrors=0;var typingwords=document.getElementsByClassName("typing-words")[0]
...
$(document).ready(function(){setuptypingtest();setInterval(updateunderscoreposition,50);});document.addEventListener('keydown',function(event){if(testposition==testlength){console.log("test end")
...
if(String.fromCharCode(event.keyCode).toLowerCase()==testtarget[testposition]){typingwords.children[testposition].className="typing-letter-confirmed";testposition++;}else if(event.keyCode==8){if(testposition!=0){if(typingwords.children[testposition-1].className=="typing-letter-error"){testerrors--;}
typingwords.children[testposition-1].className="typing-letter-unconfirmed";testposition--;}}
else{typingwords.children[testposition].className="typing-letter-error";testposition++;testerrors++;}
displayresults()
