...
function triggerend(){if(testposition==testlength){teststatus=0;document.getElementsByClassName("typing-letter-indicator")[0].style.transform="translateX(-100vw) scaleX(22)";}}
$(document).ready(function(){setuptypingtest();setInterval(updateunderscoreposition,50);setInterval(updateunderscorescale,50);});document.addEventListener('keydown',function(event){if(testposition==testlength){console.log("test end")
...
if(String.fromCharCode(event.keyCode).toLowerCase()==testtarget[testposition]){typingwords.children[testposition].className="typing-letter-confirmed";testposition++;scaleoffset++;if(testposition==testlength){triggerend()}}else if(event.keyCode==8){if(testposition!=0){if(typingwords.children[testposition-1].className=="typing-letter-error"){testerrors--;scaleoffset--;}
typingwords.children[testposition-1].className="typing-letter-unconfirmed";testposition--;scaleoffset--;}}
else{typingwords.children[testposition].className="typing-letter-error";testposition++;testerrors++;scaleoffset++;if(testposition==testlength){triggerend()}}
displayresults()
