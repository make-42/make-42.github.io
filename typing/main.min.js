...
$(document).ready(function(){setuptypingtest();setInterval(updateunderscoreposition,50);setInterval(updateunderscorescale,50);});document.addEventListener('keydown',function(event){if(testposition+1==testlength){teststatus=0;document.getElementsByClassName("typing-letter-indicator")[0].style.transform="skewX(180deg) scaleX(0)";}
if(testposition==testlength){console.log("test end")
