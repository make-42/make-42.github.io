...
$(document).ready(function(){setuptypingtest();});document.addEventListener('keydown',function(event){if(testposition==testlength){console.log("test end")
